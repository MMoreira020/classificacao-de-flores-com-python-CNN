...
TRAIN_DIR = "C:/Python-Redes Neurais/flowers/Train"
TEST_DIR = "C:/Python-Redes Neurais/flowers/Test"
VAL_DIR = "C:/Python-Redes Neurais/flowers/Validate"

# aumento e pré-praração de dados 
...
#salvar modelo
model.save('C:/Python-Redes Neurais/flowers/flowers.h5')